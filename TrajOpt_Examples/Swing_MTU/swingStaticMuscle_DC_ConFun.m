function c = swingStaticMuscle_DC_ConFun(X,auxdata)
%
...
% add muscle equliaty constraints *for leg*
...
for i = 1:N
    ...
    ceq_mus((i-1)*nDOF+1 : i*nDOF) = tau - controls(i,ctrl_tau)'.*(tor_limit');  % f(a,l,dl) - tau == 0
end
c = [ceq; ceq_mus];
